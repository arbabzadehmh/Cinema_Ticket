...
//                            .saloon(saloon1)
//                            .show(show1)
//                            .startTime(LocalDateTime.of(2024, 8, 12, 18, 30))
//                            .endTime(LocalDateTime.of(2024, 8, 12, 20, 30))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
...
//                            .saloon(saloon1)
//                            .show(show1)
//                            .startTime(LocalDateTime.of(2024, 8, 12, 21, 0))
//                            .endTime(LocalDateTime.of(2024, 8, 12, 23, 0))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
...
//                            .saloon(saloon2)
//                            .show(show2)
//                            .startTime(LocalDateTime.of(2024, 8, 13, 17, 0))
//                            .endTime(LocalDateTime.of(2024, 8, 13, 19, 0))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
...
//                            .saloon(saloon2)
//                            .show(show4)
//                            .startTime(LocalDateTime.of(2024, 8, 13, 20, 0))
//                            .endTime(LocalDateTime.of(2024, 8, 13, 22, 0))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
...
//                            .saloon(saloon3)
//                            .show(show3)
//                            .startTime(LocalDateTime.of(2024, 8, 13, 18, 30))
//                            .endTime(LocalDateTime.of(2024, 8, 13, 20, 30))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
...
//                            .saloon(saloon4)
//                            .show(show4)
//                            .startTime(LocalDateTime.of(2024, 8, 13, 18, 0))
//                            .endTime(LocalDateTime.of(2024, 8, 13, 20, 0))
//                            .showSeats(null)
//                            .status(true)
//                            .deleted(false)
//                            .description("test")
